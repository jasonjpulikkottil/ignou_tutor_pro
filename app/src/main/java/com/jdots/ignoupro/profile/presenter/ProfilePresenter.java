package com.jdots.ignoupro.profile.presenter;
...
import com.jdots.ignoupro.navigation.ProfileNavigator;
...
public class ProfilePresenter {
    ...
    private User self;
    private final ProfileDisplayer.ProfileActionListener actionListener = new ProfileDisplayer.ProfileActionListener() {
    ...
    private final ProfileNavigator.ProfileDialogListener dialogListener = new ProfileNavigator.ProfileDialogListener() {
